          ...
          <div className="max-w-[140rem] w-full mx-auto">
            <div className="section section-account pt-0 w-full flex gap-10 justify-between flex-wrap md:flex-nowrap h-full">
              <div className="sm:flex-[3] w-full" data-aos="fade-right">
                <h2 className="text-5xl font-bold text-black font-Rubik">login</h2>
                ...
                <p className="font-medium cursor-pointer hover:underline normal-case text-2xl mb-5 -mt-2" data-aos="fade-up" data-aos-delay="300">
                ...
                >
                  <div className="flex items-center gap-2 w-full justify-between">
                    {loading ? (
                      ...
                      <>
                        <span className="uppercase font-semibold font-Rubik">Log In</span>
                ...
                <div className="flex items-center justify-between gap-6 w-full" data-aos="fade-up" data-aos-delay="600">
                ...
                <p className="text-2xl font-normal my-5 font-Rubik normal-case" data-aos="fade-up" data-aos-delay="700">
                  By clicking
                  <span className="font-bold px-2 normal-case font-Rubik">'log in'</span>
                  you agree to our website KicksClub Terms & Conditions, Kicks Privacy Notice and Terms & Conditions.
                </p>

                <p className="text-2xl normal-case font-medium" data-aos="fade-up" data-aos-delay="800">
                  Don't have an account?
                  <Link to="/sign-up" className="text-black ml-2 hover:underline font-bold">
                    Sign up
                  </Link>
                </p>
              </div>

              <div className="sm:flex-[4] bg-white p-5 rounded-xl max-h-fit w-full" data-aos="fade-left">
                <div className="flex flex-col sm:gap-y-5 gap-y-8 w-full">
                  ...
                  <ul className="flex flex-col gap-y-3 ml-10 font-medium text-2xl normal-case">
                    <li className="list-disc" data-aos="fade-up" data-aos-delay="100">
                      Free Shipping
                    </li>
                    <li className="list-disc" data-aos="fade-up" data-aos-delay="200">
                      A 15% off voucher for your next purchase​
                    </li>
                    <li className="list-disc" data-aos="fade-up" data-aos-delay="300">
                      Access to Members Only products and sales​
                    </li>
                    <li className="list-disc" data-aos="fade-up" data-aos-delay="400">
                      Access to adidas Running and Training apps​
                    </li>
                    <li className="list-disc" data-aos="fade-up" data-aos-delay="500">
                      Special offers and promotions​
                    </li>
                  </ul>
                  <p className="text-2xl font-medium normal-case" data-aos="fade-up" data-aos-delay="600">
