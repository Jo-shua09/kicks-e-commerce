  ...
  return (
    <div className="section !pt-2">
      <div className="sm:hidden flex justify-between items-center w-full">
        <div className="text-2xl uppercase font-Rubik font-medium bg-white rounded-2xl py-4 px-7 gap-x-14 flex items-center justify-between">
      ...
      <div className="flex items-center mt-10 justify-between w-full">
        ...
        <div className=" sm:flex hidden text-2xl uppercase font-Rubik font-semibold bg-white rounded-2xl py-4 px-7 gap-x-14 items-center justify-between">
          trending <ArrowDropDown sx={{ fontSize: "2rem" }} />
        </div>
      </div>
