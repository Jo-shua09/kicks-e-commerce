    ...
    <div className="section-two !pt-0">
      <div className="relative w-full h-full">
        ...
        <div className=" lg:w-1/3 sm:w-1/2 w-2/3 absolute top-1/2 sm:left-16 left-7 bottom-0">
          <h4 className="sm:text-3xl text-2xl text-gray-300 font-medium normal-case mb-4">Limited time only</h4>
          <h2 className="sm:text-7xl text-5xl text-white font-Rubik font-bold mb-4">get 30% off</h2>
