                    ...
                    <div className="p-5">
                      <div className="flex items-center justify-between">
                        <div className="flex flex-col w-[72%]">
                          <h4 className="text-3xl font-semibold font-Rubik">{data.name}</h4>
                          <p className="text-2xl font-normal normal-case">{data.review}</p>
                        </div>
                        <div className="">
                          <img src={data.person} alt="review person" className="w-full h-full object-cover" />
                        </div>
                      </div>
                      <div className="flex mt-2">
                        {[...Array(5)].map((_, index) => (
                          <Star key={index} sx={{ fontSize: "1.8rem" }} className={index < data.rating ? "text-yellow-400" : "text-gray-300"} />
                        ))}
                      </div>
                    </div>
                    <div className="">
