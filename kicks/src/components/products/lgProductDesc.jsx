        ...
        <div className="flex-[3] w-max mx-auto mr-10 h-full flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-x-4">
                {Colors.map((color) => (
                  ...
                  >
                    <div
                      className={`text-white ${color.color} p-7 text-sm rounded-full normal-case font-bold font-Rubik cursor-pointer`}
                    ></div>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:mt-10 mt-5">
            ...
            <div className="text-gray-600">
              <p className="text-[1.5rem] normal-case">
                This product is excluded from all promotional discounts and
                offers.
              </p>
              <ul className="pl-[2.5rem]">
                <li className="list-disc text-xl pb-1 normal-case">
