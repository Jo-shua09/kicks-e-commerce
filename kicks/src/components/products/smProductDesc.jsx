    ...
    <div className="section-two mb-10">
          ...
          <SwiperSlide key={list.id}>
            <div className="flex justify-around w-full rounded-3xl gap-x-5 h-max">
              <img
                src={list.image}
                alt="product image"
                className="w-full mt-10 h-[20rem] border border-gray-50 rounded-3xl object-cover"
              />
            </div>
          </SwiperSlide>
        ))}
      ...
      <div className="flex-[2] mt-16 w-full h-full flex flex-col">
        ...
        <div className="lg:mt-10 mt-14">
          <h4 className="text-3xl lg:mb-4 mb-6 font-semibold font-Rubik uppercase">
            about the product
          </h4>
          <p className="text-gray-600 lg:mb-4 mb-6 text-2xl">
            shadow navy - army green
          </p>
          <div className="text-gray-600">
            <p className="text-[1.9rem] pb-2 normal-case">
              This product is excluded from all promotional discounts and
              offers.
            </p>
            <ul className="pl-[4rem] text-3xl">
              <li className="list-disc pb-2 normal-case">
